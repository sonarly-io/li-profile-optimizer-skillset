...
When the user asks to audit, rewrite, score, compare, or optimize a LinkedIn profile, follow `skills/linkedin-profile-analysis/SKILL.md`.
...
5. Prioritize concrete profile improvements by impact.
6. Preserve factual truth when rewriting and use placeholders for unverified metrics or claims.
